...
void AGame3Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AGame3Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AGame3Character::TouchStopped);

	// Screenshot key
	PlayerInputComponent->BindAction("StartCapture", IE_Pressed, this, &AGame3Character::StartCapture);
	// Emulation Profile
	PlayerInputComponent->BindAxis("EmulationProfile", this, &AGame3Character::SetEmulationProfile);
}

void AGame3Character::FindCapturer()
{
...
void AGame3Character::StartCapture()
{
...
void AGame3Character::SetEmulationProfile(float profile_index)
{
	if(emul_mode)
	{
...
void AGame3Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}

void AGame3Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	StopJumping();
}
